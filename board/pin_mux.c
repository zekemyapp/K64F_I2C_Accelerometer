...
- {pin_num: '32', pin_signal: ADC0_SE18/PTE25/UART4_RX/I2C0_SDA/EWM_IN, label: I2C0_SDA, identifier: ACCEL_SDA;ACCE_SDA}
- {pin_num: '31', pin_signal: ADC0_SE17/PTE24/UART4_TX/I2C0_SCL/EWM_OUT_b, label: I2C0_SCL, identifier: ACCEL_SCL;ACCE_SCL}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
I2C0_InitPins:
- options: {callFromInitBoot: 'false', prefix: I2C0_, coreID: core0, enableClock: 'true'}
- pin_list:
...
void I2C0_InitPins(void)
{
    ...
    PORT_SetPinConfig(I2C0_ACCEL_SCL_PORT, I2C0_ACCEL_SCL_PIN, &ACCEL_SCL);
    ...
    PORT_SetPinConfig(I2C0_ACCEL_SDA_PORT, I2C0_ACCEL_SDA_PIN, &ACCEL_SDA);
}
 ...
 * Description   : Removes pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
GPIO_InitPins:
- options: {callFromInitBoot: 'true', prefix: GPIO_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '55', peripheral: GPIOB, signal: 'GPIO, 2', pin_signal: ADC0_SE12/PTB2/I2C0_SCL/UART0_RTS_b/ENET0_1588_TMR0/FTM0_FLT3, identifier: ''}
  ...
  - {pin_num: '58', peripheral: GPIOB, signal: 'GPIO, 10', pin_signal: ADC1_SE14/PTB10/SPI1_PCS0/UART3_RX/FB_AD19/FTM0_FLT1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
