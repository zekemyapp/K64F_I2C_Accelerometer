...
/*! @name PORTE25 (number 32), I2C0_SDA
  @{ */
#define I2C0_ACCEL_SDA_PORT PORTE /*!<@brief PORT device name: PORTE */
#define I2C0_ACCEL_SDA_PIN 25U    /*!<@brief PORTE pin index: 25 */
                                  /* @} */

/*! @name PORTE24 (number 31), I2C0_SCL
  @{ */
#define I2C0_ACCEL_SCL_PORT PORTE /*!<@brief PORT device name: PORTE */
#define I2C0_ACCEL_SCL_PIN 24U    /*!<@brief PORTE pin index: 24 */
                                  /* @} */
...
/*!
 * @brief Removes pin routing and optionally pin electrical features.
 *
 */
